...
class IntelligentDenoiseSetParamsVC: UIViewController, UITextFieldDelegate {

    override func viewDidLoad() {
        super.viewDidLoad()

        // Do any additional setup after loading the view.
        self.title = "Intelligent Denoise".localized
        
        self.channelIdTextField.delegate = self
    }
    
    @IBOutlet weak var intelligentDenoiseSwitch: UISwitch!
    ...
    @IBAction func onJoinChannelBtnClicked(_ sender: Any) {
        ...
        let vc = self.presentVC(storyboardName: "IntelligentDenoise", storyboardId: "MainVC") as? IntelligentDenoiseMainVC
        vc?.channelId = channelId
        vc?.userId = userId
        vc?.joinToken = joinToken
        vc?.isEnableIntelligentDenoise = self.intelligentDenoiseSwitch.isOn
    }
...
class IntelligentDenoiseMainVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.intelligentDenoiseSwitch.isOn = isEnableIntelligentDenoise
    ...
    @IBOutlet weak var intelligentDenoiseSwitch: UISwitch!
    @IBAction func intelligentDenoiseSwitchToggled(_ sender: UISwitch) {
        guard let engine = self.rtcEngine else {return}
        
        if sender.isOn {
            engine.startIntelligentDenoise()
        } else {
            engine.stopIntelligentDenoise()
        }
    }
    ...
    var isEnableIntelligentDenoise: Bool = false
...
extension IntelligentDenoiseMainVC: AliRtcEngineDelegate {
