...
//  ARTCExample
//
//  Created by wy on 2025/7/7.
//

import Foundation
import AliVCSDK_ARTC

class SEIUsageSetParamsVC: UIViewController, UITextFieldDelegate {

    override func viewDidLoad() {
        super.viewDidLoad()

        // Do any additional setup after loading the view.
        self.title = "SEI Sending and Receiving".localized
    ...
    @IBAction func onJoinChannelBtnClicked(_ sender: Any) {
        ...
        let vc = self.presentVC(storyboardName: "SEIUsage", storyboardId: "MainVC") as? SEIUsageMainVC
...
class SEIUsageMainVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.SEIInputTextField.delegate = self
    ...
    @IBOutlet weak var SEIInputTextField: UITextField!
    
    @IBAction func onSEISendButtonClicked(_ sender: UIButton) {
        guard let seiMessage = self.SEIInputTextField.text, seiMessage.isEmpty == false else {
            return
        }
        
        if self.sendSEI(seiMessage: seiMessage) {
...
extension SEIUsageMainVC: UITextFieldDelegate {
